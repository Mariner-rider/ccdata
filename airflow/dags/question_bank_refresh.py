"""Weekly refresh DAG for competitive-exam question bank content."""
...
except ImportError:  # pragma: no cover - allows import checks outside Airflow
    DAG = None
    BashOperator = None

EXAM_TYPES = ["NDA", "JEE", "BANKING", "RAILWAY", "SSC", "UPSC"]
...
if DAG and BashOperator:
    with DAG(
        ...
        crawl_tasks = [
            BashOperator(
                task_id=f"crawl_{exam.lower()}_questions",
